 ...
 * @author azizk
 */
public class AddTopicForm extends BaseFormBack {
    
     public AddTopicForm(Form previous,Resources res) {
...
int idUser = enn.get(users.getSelectedIndex()).getId();
                        if(ServiceTopic.getInstance().add(tfTitre, tfDescription,idUser))
