 ...
 * @author rihem
 */
public class EditTopicForm extends BaseFormBack {
    
    public EditTopicForm(Form previous,Resources res,Topic topic) {
        ...
        setLayout(BoxLayout.yCenter());
                   TextField tfTitre = new TextField(topic.getTitretopic());
        TextField tfDescription = new TextField(topic.getDescription());
             ...
             public void actionPerformed(ActionEvent evt) {
                 if ((tfTitre.getText().length()==0)||(tfDescription.getText().length()==0)  )
                    ...
                    try {
                        ...
                        if(ServiceTopic.getInstance().update(topic.getIdtopic(), tfTitre, tfDescription, idUser))
